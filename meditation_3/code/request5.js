...
function predict(){
  ...
  let prediction = "Tomorrow you will have a " + adjs[Math.floor(Math.random() * adjs.length)] + " day. You should expect a " + adjs[Math.floor(Math.random() * adjs.length)] + " " + nouns[Math.floor(Math.random() * nouns.length)] + " to come your way, and because of this you might be feeling a bit " + adjs[Math.floor(Math.random() * adjs.length)] + "."
  // print it
